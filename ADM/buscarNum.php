...
$sql2 = mysql_query("SELECT * FROM documento JOIN tipo_documento where num_documento = '$buscar2' AND tipo_documento_cod = documento_tipo_fk");
...
if ($result2>=1) 
	{
           echo "Exibindo ".$result2." resultados para o número de documento <strong>".$buscar2."</strong><br><br>";
