      ...
      <nav class="navbar navbar-static">
        ...
        <span class="glyphicon glyphicon-chevron-down"></span>
            ...
            <div class="btn-group btn-group-lg">
              ...
              <ul class="dropdown-menu" role="menu">
                <li>
                  <a href="ADM_Atas.html">Atas de Reuniões</a>
                </li>
                <li>
            ...
            <div class="panel-body">
              <div class="well">
                ...
                <p>In simple terms, a responsive web design figures out what resolution of
                  ...
                  the screen.</p>
                <p>
                  <a href="http://www.bootply.com/bootstrap-3-migration-guide" target="ext">Read our migration guide for help with upgrading to Bootstrap 3.</a>
                </p>
              </div>
              <hr>
              <div class="media"></div>
        ...
        <div class="col-md-7" id="content">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-8">
                  <h2>Bem vindo ao Portal dos cursos Técnicos em Informática
            </div>
            <!--/panel-body-->
          </div>
          <!--/panel-->
