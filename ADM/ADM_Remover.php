                    ...
                    <div class="panel" id="midCol">
                        ...
                        <div class="panel-body">
                            <div class="well">
                                ...
                                <h3>
                                    <a href="http://www.formiga.ifmg.edu.br">Campus Formiga</a>
                                </h3>
...
informações que poderão ser encontradas no site do <i>campus</i> Formiga</p>
                ...
                <div class="col-md-7" id="content">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <b>
                                <h2>Remover Documento</h2>
                            </b>
                            <br>
                            <br>
                                <div>
                                   <form method="post" action="buscarDel.php">

				Tipo : &nbsp;<select name="tipo" value="tipo" id="tipo">
                                       <?
...
<br><br></form>
               <form method="post" action="buscarNumDel.php">                     Número : &nbsp;<input type="text" name="buscar2">&nbsp;<input type="submit" value="Buscar" name="buscar"></form>
<form method="post" action="buscardataDel.php">
<br><br>
				 Data de Criação :&nbsp;<input type="date" name="buscar3">&nbsp;<input type="submit" value="Buscar" name="buscar"></form>

<br><br><form method="post" action="buscartagDel.php">
