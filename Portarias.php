<html><head>
	...
	<button class="btn btn-lg btn-success" type="button" onclick="location.href='poc.html'">POC</button>
            ...
            <div class="btn-group btn-group-lg">
              ...
              </ul><button class="btn btn-lg btn-success" type="button" onclick="location.href='poc.html'">POC</button>
            </div>
...
<?
$sql = "SELECT * FROM documento JOIN tipo_documento where tipo_nome= 'Portarias' AND tipo_documento_cod = documento_tipo_fk";
