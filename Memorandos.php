    ...
    <header class="masthead">
      ...
      <nav class="navbar navbar-static">
        ...
        <span class="glyphicon glyphicon-chevron-down"></span>
            ...
            <button class="btn btn-lg btn-success" type="button" onclick="location.href='curso.html'">Curso</button>
            <button class="btn btn-lg btn-success" type="button" onclick="location.href='colegiado.html'">Colegiado</button>
	    <button class="btn btn-lg btn-success" type="button" onclick="location.href='docentes.html'">Docentes</button>
	 <button class="btn btn-lg btn-success" type="button" onclick="location.href='projeto_pedagogico.html'">Projeto Pedagógico</button>
	  <button class="btn btn-lg btn-success" type="button" onclick="location.href='matriz_curricular.html'">Matriz Curricular</button>
	<button class="btn btn-lg btn-success" type="button" onclick="location.href='poc.html'">POC</button>
            ...
            <div class="btn-group btn-group-lg">
              ...
              <ul class="dropdown-menu" role="menu">
                <li>
                  <a href="Atas.html">Atas de Reuniões</a>
                </li>
                <li>
                  <a href="Portarias.html">Portarias</a>
                </li>
                <li>
                  <a href="Memorandos.html">Memorandos</a>
                </li>
                <li>
                  <a href="Resoluções.html">Resoluções</a>
                </li>
              </ul><button class="btn btn-lg btn-success" type="button" onclick="location.href='contato.html'">Contato</button>
            </div>
        ...
        <div class="col-md-7" id="content">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <br><b>Nota : </b><p>&nbsp;&nbsp;&nbsp;&nbsp;Os documentos assumidos como norteadores para a proposta aqui apresentada são as bases legais contidas na Lei de Diretrizes e Bases da Educação Nacional de 20 de dezembro de 1996, bem como o Catálogo Nacional de Cursos Técnicos do MEC (Ministério da Educação) Parecer CNE/CEB nº 11/2012 que trata das Diretrizes Curriculares Nacionais para a Educação Profissional Técnica de Nível Médio; Resolução CNE/CEB nº 06/2012 que define as Diretrizes Curriculares Nacionais para a Educação Profissional Técnica de Nível Médio; Decreto nº 5.154/2004 que regulamenta o § 72º do art. 36 e os artigos 39 a 41 da Lei nº 9.394 de 1996; Parâmetros Curriculares do Ensino Médio / 2000.</p>
...
<br><br><form method="post" action="buscartag.php">
				Palavras Chave : &nbsp;<input type="text" name="buscar4">&nbsp;<input type="submit" value="Buscar" name="buscar"></form><?php
